...
export function Login({ onSwitchToSignup }: LoginProps) {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[var(--bg-main)] p-4 relative overflow-hidden">
            ...
            <div className="absolute bottom-0 left-0 w-[500px] h-[500px] bg-indigo-500/10 rounded-full blur-[120px] -ml-48 -mb-48 pointer-events-none" />
            ...
            >
                <div className="text-center mb-10">
                    ...
                    <h1 className="text-4xl font-extrabold text-slate-900 dark:text-white tracking-tight">Access <span className="text-blue-500">Vault</span></h1>
                    <p className="text-slate-500 dark:text-slate-400 mt-2 font-medium">Secure entry to your financial ecosystem</p>
                </div>
                ...
                <div className="bg-white dark:bg-[#1e293b]/50 backdrop-blur-xl rounded-[32px] border border-slate-200 dark:border-white/10 shadow-2xl p-8 md:p-10">
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={isLoading}
                            className="w-full bg-blue-600 hover:bg-blue-500 disabled:bg-blue-600/50 text-white font-black py-4 rounded-2xl shadow-xl shadow-blue-500/20 transition-all active:scale-[0.98] flex items-center justify-center gap-3 uppercase tracking-widest text-sm"
                        >
                            {isLoading ? (
